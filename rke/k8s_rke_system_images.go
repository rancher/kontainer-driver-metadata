...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.18.18-rancher1-3": {
			...
			WeaveNode:                 "weaveworks/weave-kube:2.6.4",
			WeaveCNI:                  "weaveworks/weave-npc:2.6.4",
			AciCniDeployContainer:     "noiro/cnideploy:5.1.3.3.6f00d68",
			AciHostContainer:          "noiro/aci-containers-host:5.1.3.3.6f00d68",
			AciOpflexContainer:        "noiro/opflex:5.1.3.3.6f00d68",
			AciMcastContainer:         "noiro/opflex:5.1.3.3.6f00d68",
			AciOpenvSwitchContainer:   "noiro/openvswitch:5.1.3.3.6f00d68",
			AciControllerContainer:    "noiro/aci-containers-controller:5.1.3.3.6f00d68",
			AciGbpServerContainer:     "noiro/gbp-server:5.1.3.3.6f00d68",
			AciOpflexServerContainer:  "noiro/opflex-server:5.1.3.3.6f00d68",
			PodInfraContainer:         "rancher/mirrored-pause:3.1",
			Ingress:                   "rancher/nginx-ingress-controller:nginx-0.35.0-rancher2",
			IngressBackend:            "rancher/mirrored-nginx-ingress-controller-defaultbackend:1.5-rancher1",
			MetricsServer:             "rancher/mirrored-metrics-server:v0.3.6",
