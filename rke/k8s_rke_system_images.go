...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.22.15-rancher1-2": {
			...
			WeaveNode:                 "weaveworks/weave-kube:2.8.1",
			WeaveCNI:                  "weaveworks/weave-npc:2.8.1",
			AciCniDeployContainer:     "quay.io/noiro/cnideploy:5.2.3.4.1d150da",
			AciHostContainer:          "quay.io/noiro/aci-containers-host:5.2.3.4.1d150da",
			AciOpflexContainer:        "quay.io/noiro/opflex:5.2.3.4.1d150da",
			AciMcastContainer:         "quay.io/noiro/opflex:5.2.3.4.1d150da",
			AciOpenvSwitchContainer:   "quay.io/noiro/openvswitch:5.2.3.4.1d150da",
			AciControllerContainer:    "quay.io/noiro/aci-containers-controller:5.2.3.4.1d150da",
			AciGbpServerContainer:     "quay.io/noiro/gbp-server:5.2.3.4.1d150da",
			AciOpflexServerContainer:  "quay.io/noiro/opflex-server:5.2.3.4.1d150da",
			PodInfraContainer:         "rancher/mirrored-pause:3.6",
			Ingress:                   "rancher/nginx-ingress-controller:nginx-1.2.1-rancher1",
			IngressBackend:            "rancher/mirrored-nginx-ingress-controller-defaultbackend:1.5-rancher1",
			IngressWebhook:            "rancher/mirrored-ingress-nginx-kube-webhook-certgen:v1.1.1",
