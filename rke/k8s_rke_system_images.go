...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		// Enabled as a way to upgrade from broken "1.16.4-rancher1-1"
		"v1.16.4-rancher1-2": {
			Etcd:                      m("quay.io/coreos/etcd:v3.3.15-rancher1"),
			Kubernetes:                m("rancher/hyperkube:v1.16.4-rancher1"),
			Alpine:                    m("rancher/rke-tools:v0.1.51"),
		...
		// Enabled in Rancher v2.3.4, copy of "v1.16.4-rancher1-1"
		// Downgrading calico images, 1.16.x would always use calico 3.8 to be compatible with calicov116 template
		"v1.16.4-rancher1-3": {
			Etcd:                      m("quay.io/coreos/etcd:v3.3.15-rancher1"),
			Kubernetes:                m("rancher/hyperkube:v1.16.4-rancher1"),
			Alpine:                    m("rancher/rke-tools:v0.1.52"),
		...
		// Enabled as a way to upgrade from broken "v1.17.0-rancher1-2"
		"v1.17.0-rancher1-3": {
			Etcd:                      m("quay.io/coreos/etcd:v3.4.3-rancher1"),
			Kubernetes:                m("rancher/hyperkube:v1.17.0-rancher1"),
			Alpine:                    m("rancher/rke-tools:v0.1.51"),
		...
		// Enabled in 2.3.4, copy of "v1.17.0-rancher1-2"
		"v1.17.0-rancher1-4": {
			Etcd:                      m("quay.io/coreos/etcd:v3.4.3-rancher1"),
			Kubernetes:                m("rancher/hyperkube:v1.17.0-rancher1"),
			Alpine:                    m("rancher/rke-tools:v0.1.52"),
