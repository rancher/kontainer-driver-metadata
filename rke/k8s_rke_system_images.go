...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.21.0-rancher1-1": {
			...
			Flannel:                   "rancher/coreos-flannel:v0.13.0-rancher1",
			FlannelCNI:                "rancher/flannel-cni:v0.3.0-rancher6",
			CalicoNode:                "rancher/mirrored-calico-node:v3.19.0",
			CalicoCNI:                 "rancher/mirrored-calico-cni:v3.19.0",
			CalicoControllers:         "rancher/mirrored-calico-kube-controllers:v3.19.0",
			CalicoCtl:                 "rancher/mirrored-calico-ctl:v3.19.0",
			CalicoFlexVol:             "rancher/mirrored-calico-pod2daemon-flexvol:v3.19.0",
			CanalNode:                 "rancher/mirrored-calico-node:v3.19.0",
			CanalCNI:                  "rancher/mirrored-calico-cni:v3.19.0",
			CanalControllers:          "rancher/mirrored-calico-kube-controllers:v3.19.0",
			CanalFlannel:              "rancher/coreos-flannel:v0.13.0-rancher1",
			CanalFlexVol:              "rancher/mirrored-calico-pod2daemon-flexvol:v3.19.0",
			WeaveNode:                 "weaveworks/weave-kube:2.8.1",
			WeaveCNI:                  "weaveworks/weave-npc:2.8.1",
			AciCniDeployContainer:     "noiro/cnideploy:5.1.1.0.1ae238a",
			AciHostContainer:          "noiro/aci-containers-host:5.1.1.0.1ae238a",
			...
			Ingress:                   "rancher/nginx-ingress-controller:nginx-0.46.0-rancher1",
			IngressBackend:            "rancher/mirrored-nginx-ingress-controller-defaultbackend:1.5-rancher1",
			MetricsServer:             "rancher/mirrored-metrics-server:v0.4.4",
