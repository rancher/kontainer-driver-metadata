...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.20.2-rancher2-1": {
			...
			Flannel:                   m("quay.io/coreos/flannel:v0.13.0-rancher1"),
			FlannelCNI:                m("rancher/flannel-cni:v0.3.0-rancher6"),
			CalicoNode:                m("quay.io/calico/node:v3.17.1"),
			CalicoCNI:                 m("quay.io/calico/cni:v3.17.1"),
			CalicoControllers:         m("quay.io/calico/kube-controllers:v3.17.1"),
			CalicoCtl:                 m("quay.io/calico/ctl:v3.17.1"),
			CalicoFlexVol:             m("quay.io/calico/pod2daemon-flexvol:v3.17.1"),
			CanalNode:                 m("quay.io/calico/node:v3.17.1"),
			CanalCNI:                  m("quay.io/calico/cni:v3.17.1"),
			CanalControllers:          m("quay.io/calico/kube-controllers:v3.17.1"),
			CanalFlannel:              m("quay.io/coreos/flannel:v0.13.0-rancher1"),
			CanalFlexVol:              m("quay.io/calico/pod2daemon-flexvol:v3.17.1"),
