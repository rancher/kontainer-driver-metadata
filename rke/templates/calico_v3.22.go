...
/*
CalicoTemplateV3_22_5 is based on upstream calico v3.22.5
Upstream Changelog:
- Add some new properties in crds
- Add an initcontainer for BPF data plane in calico-node daemonset
Rancher Changelog:
- No new Rancher specific changes, same as CalicoTemplateV3_21_1
*/

const CalicoTemplateV3_22_5 = `
