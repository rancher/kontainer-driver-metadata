...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.NginxIngress: {
			...
			">=1.17.6-rancher1-1 <1.19.15-rancher1-2": nginxIngressV11512,
			">=1.19.15-rancher1-2 <1.20.0-rancher0":   nginxIngressv104,
			">=1.20.0-rancher0 <1.20.11-rancher1-2":   nginxIngressV11512,
			">=1.20.11-rancher1-2":                    nginxIngressv104,
		},
		kdm.Nodelocal: {
