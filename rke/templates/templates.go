...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.NginxIngress: {
			...
			"=1.15.12-rancher1-2":                    nginxIngressV11512,
			">1.15.12-rancher1-2 <1.16.9-rancher1-2": nginxIngressV115,
			"=1.16.9-rancher1-2":                     nginxIngressV11512,
			">1.16.9-rancher1-2 <1.17.5-rancher1-2":  nginxIngressV115,
			"=1.17.5-rancher1-2":                     nginxIngressV11512,
			">1.17.5-rancher1-2":                     nginxIngressV115,
		},
		kdm.Nodelocal: {
