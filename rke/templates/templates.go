...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		kdm.Calico: {
			">=1.17.3-rancher1-2":                   calicov117Privileged,
			">=1.17.0-rancher0 <1.17.3-rancher1-2":  calicov117,
			">=1.16.7-rancher1-2 <1.17.0-rancher0":  calicov117Privileged,
			">=1.16.4-rancher1 <1.16.7-rancher1-2":  calicov117,
			">=1.16.0-alpha <1.16.4-rancher1":       calicov116,
			">=1.15.10-rancher1-2 <1.16.0-alpha":    calicov115Privileged,
			">=1.15.0-rancher0 <1.15.10-rancher1-2": calicov115,
			">=1.13.0-rancher0 <1.15.0-rancher0":    calicov113,
			">=1.8.0-rancher0 <1.13.0-rancher0":     calicov18,
		},
		kdm.Canal: {
			">=1.17.3-rancher1-2":                   canalv117Privileged,
			">=1.17.0-rancher0 <1.17.3-rancher1-2":  canalv117,
			">=1.16.7-rancher1-2 <1.17.0-rancher0":  canalv117Privileged,
			">=1.16.4-rancher1 <1.16.7-rancher1-2":  canalv117,
			">=1.16.0-alpha <1.16.4-rancher1":       canalv116,
			">=1.15.10-rancher1-2 <1.16.0-alpha":    canalv115Privileged,
			">=1.15.0-rancher0 <1.15.10-rancher1-2": canalv115,
		...
		kdm.Nodelocal: {
			">=1.15.10-rancher1-2 <1.16.0-alpha": nodelocalv115,
			">=1.16.7-rancher1-2 <1.17.0-alpha":  nodelocalv115,
			">=1.17.3-rancher1-2":                nodelocalv115,
		},
