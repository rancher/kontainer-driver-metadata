...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		Calico: {
			...
			">=1.8.0-rancher0 <1.13.0":        calicov18,
		},
		Canal: {
		...
		// split at 1.13.10-rancher1-3, 1.14.6-rancher2-1, 1.15.3-rancher2-1
		NginxIngress: {
			">=1.8.0-rancher0 <1.13.10-rancher1-3 || " +
				">=1.14.0-rancher0 <1.14.6-rancher2-1 || >=1.15.0-rancher0 <1.15.3-rancher2-1": nginxIngressv18,

			">=1.13.10-rancher1-3 <1.14.0-rancher0 ||" +
				" >=1.14.6-rancher2-1 <1.15.0-rancher0 || >=1.15.3-rancher2-1":          nginxIngressV115,
		},
