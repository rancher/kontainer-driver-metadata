...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.NginxIngress: {
			...
			">=1.19.16-rancher1-1 <1.20.0-rancher0":   nginxIngressv0493,
			...
			">=1.21.6-rancher1-1 <1.22.0-rancher1-1":  nginxIngressv0493,
			">=1.22.0-rancher1-1":                     nginxIngressv104,
		},
		kdm.Nodelocal: {
...
func getTemplates() map[string]string {
	return map[string]string{
		...
		calicov3202:          CalicoTemplateV3_20_2,
		...
		canalv3202:                    CanalTemplateV3_20_2,
