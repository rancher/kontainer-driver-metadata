...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.22.11-rancher1-1 <1.22.15-rancher1-2": aciv523,
			">=1.22.15-rancher1-2 <1.23.0-rancher0":    aciv5234,
			">=1.23.0-rancher0 <1.23.8-rancher1-1":     aciv500,
			">=1.23.8-rancher1-1 <1.23.12-rancher1-2":  aciv523,
			">=1.23.12-rancher1-2 <1.24.0-rancher0":    aciv5234,
			">=1.24.0-rancher0 <1.24.6-rancher1-2":     aciv523,
			">=1.24.6-rancher1-2":                      aciv5234,
		},
		kdm.NginxIngress: {
