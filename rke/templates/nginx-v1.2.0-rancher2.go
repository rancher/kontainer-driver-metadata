...
- Based off of v1.2.0-rancher3 + upstream app changes to v1.2.0
*/
const NginxIngressTemplateV120Rancher2 = `
# Based on https://github.com/kubernetes/ingress-nginx/blob/controller-v1.2.0/deploy/static/provider/cloud/deploy.yaml
apiVersion: v1
kind: Namespace
metadata:
  name: ingress-nginx
