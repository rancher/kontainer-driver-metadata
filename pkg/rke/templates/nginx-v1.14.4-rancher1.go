...
/*
Upstream Changelog:
- update app.kubernetes.io/version label value from 1.14.3 to 1.14.4
- Updated admission webhook jobs to use kube-webhook-certgen v1.6.8
...
*/
const NginxIngressTemplateV1144Rancher1 = `
# Based on https://github.com/kubernetes/ingress-nginx/blob/controller-v1.14.4/deploy/static/provider/cloud/deploy.yaml
apiVersion: v1
kind: Namespace
metadata:
  labels:
