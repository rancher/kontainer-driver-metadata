...
/*
Upstream Changelog:
- update app.kubernetes.io/version label value from 1.12.0 to 1.13.0
...
*/
const NginxIngressTemplateV1130Rancher1 = `
# Based on https://github.com/kubernetes/ingress-nginx/blob/controller-v1.13.0/deploy/static/provider/cloud/deploy.yaml
apiVersion: v1
kind: Namespace
metadata:
  labels:
