...
// CalicoTemplateV3_16_5 based on Calico v3.16.5, no new Rancher specific changes
const CalicoTemplateV3_16_5 = `
...
// CalicoTemplateV3_17_1 based on Calico v3.17.1, it adds several changes to 3.16.5 template:
// 1. Updated CRD
// 2. Updated deployment to have cni log volume
// 3. Add PodDisruptionBudget to kubecontroller
const CalicoTemplateV3_17_1 = `
