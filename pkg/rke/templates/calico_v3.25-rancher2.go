...
/*
CalicoTemplateV3_25_0 is based on upstream calico v3.25.0
...
const CalicoTemplateV3_25_0Rancher2 = `
...
{{if .CalicoFelixConfiguration}}
apiVersion: crd.projectcalico.org/v1
kind: FelixConfiguration
metadata:
  name: default
spec:
{{ .CalicoFelixConfiguration | toYaml | indent 2 }}
{{end}}
---
