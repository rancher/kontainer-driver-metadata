...
/*
Upstream Changelog:
- update app.kubernetes.io/version label value from 1.11.2 to 1.11.3
- Added `port:443` field in webhooks.clientConfig
...
*/
const NginxIngressTemplateV1113Rancher1 = `
# Based on https://github.com/kubernetes/ingress-nginx/blob/controller-v1.11.3/deploy/static/provider/cloud/deploy.yaml
apiVersion: v1
kind: Namespace
metadata:
  labels:
