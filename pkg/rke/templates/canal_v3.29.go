...
/*
CanalTemplateV3_29_0 is based on upstream canal v3.29.0
https://raw.githubusercontent.com/projectcalico/calico/v3.29.0/manifests/canal.yaml
Upstream Changelog:
- BGPFilter: Add prefixLength to `BGPFilter“ to match on min/max prefix length
- replace `BPFRedirectToPeerFromL3Device“ with `BPFRedirectToPeer`
- added AdminNetworkPolicy
- Changes in descriptions
Rancher Changelog:
- No new Rancher specific changes, same as CanalTemplateV3_26_1
*/
const CanalTemplateV3_29_0 = `
          ...
          spec:
            ...
            properties:
              ...
              bpfEnabled:
                ...
                type: boolean
              bpfEnforceRPF:
                description: 'BPFEnforceRPF enforce strict RPF on all host interfaces with
