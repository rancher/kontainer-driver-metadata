...
/*
CalicoTemplateV3_29_0 is based on upstream calico v3.29.0
Source: https://raw.githubusercontent.com/projectcalico/calico/v3.29.0/manifests/calico.yaml
Upstream Changelog:
