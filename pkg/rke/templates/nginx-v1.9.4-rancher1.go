...
/*
Upstream Changelog:
- update app.kubernetes.io/version label value from 1.8.1 to 1.9.4
- added ingress-nginx NetworkPolicy

Rancher Changelog:
- No new Rancher specific changes, same as NginxIngressTemplateV181Rancher1
*/
const NginxIngressTemplateV194Rancher1 = `
