...
/*
Upstream Changelog:
- update app.kubernetes.io/version label value from 1.11.3 to 1.12.0
- Added new fields in batch/v1 securityContext
...
*/
const NginxIngressTemplateV1120Rancher1 = `
# Based on https://github.com/kubernetes/ingress-nginx/blob/controller-v1.12.0/deploy/static/provider/cloud/deploy.yaml
apiVersion: v1
kind: Namespace
metadata:
  labels:
