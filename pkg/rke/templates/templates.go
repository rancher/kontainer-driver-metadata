...
const (
	...
	calicov3274          = "calico-v3.27.4"
	calicov3270Rancher2  = "calico-v3.27.0-rancher2"
	calicov3280          = "calico-v3.28.0"
	calicov3281          = "calico-v3.28.1"
	calicov3290          = "calico-v3.29.0"
	calicov3302          = "calico-v3.30.2"
	...
	flannelv0251         = "flannel-v0.25.1"
	flannelv0264         = "flannel-v0.26.4"
	flannelv0273         = "flannel-v0.27.3"
	flannelv0281         = "flannel-v0.28.1"
	...
	coreDnsv183Rancher3 = "coredns-v1.8.3-rancher3"
	...
	*/
	...
	aciv6031 = "aci-v6.0.3.1"
	aciv6032 = "aci-v6.0.3.2"
	aciv6033 = "aci-v6.0.3.3"
	aciv6041 = "aci-v6.0.4.1"
	aciv6042 = "aci-v6.0.4.2"
	aciv6043 = "aci-v6.0.4.3"
	aciv6111 = "aci-v6.1.1.1"
	aciv6044 = "aci-v6.0.4.4"
	aciv6112 = "aci-v6.1.1.2"
	aciv6114 = "aci-v6.1.1.4"
	...
	nginxIngressv1145Rancher1 = "nginxingress-v1.14.5-rancher1"
...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		kdm.Calico: {
			">=1.32.6-rancher1-1":                      calicov3302,
			">=1.32.0-rancher1-1 < 1.32.6-rancher1-1":  calicov3290,
			">=1.31.10-rancher1-1 < 1.32.0-rancher1-1": calicov3302,
			">=1.31.3-rancher1-1 < 1.31.10-rancher1-1": calicov3290,
			">=1.30.4-rancher1-1 <1.31.3-rancher1-1":   calicov3281,
			">=1.30.0-rancher1-1 <1.30.4-rancher1-1":   calicov3280,
			">=1.29.8-rancher1-1 <1.30.0-rancher1-1":   calicov3274,
			">=1.29.0-rancher1-1 <1.29.8-rancher1-1":   calicov3270Rancher2,
			">=1.28.13-rancher1-1 <1.29.0-rancher1-1":  calicov3274,
			">=1.28.6-rancher1-1 <1.28.13-rancher1-1":  calicov3270,
			...
			">=1.25.16-rancher2-1 <1.26.0-rancher1-1":  calicov3261Rancher2,
			">=1.25.0-rancher1-1 <1.25.16-rancher2-1":  calicov3241,
		...
		kdm.Canal: {
			...
			">=1.30.4-rancher1-1 <1.31.3-rancher1-1":   canalv3281,
			">=1.30.0-rancher1-1 <1.30.4-rancher1-1":   canalv3280,
			">=1.29.8-rancher1-1 <1.30.0-rancher1-1":   canalv3274,
			">=1.29.0-rancher1-1 <1.29.8-rancher1-1":   canalv3270Rancher2,
			">=1.28.13-rancher1-1 <1.29.0-rancher1-1":  canalv3274,
			">=1.28.6-rancher1-1 <1.28.13-rancher1-1":  canalv3270,
			...
			">=1.25.16-rancher2-1 <1.26.0-rancher1-1":  canalv3261Rancher2,
			">=1.25.0-rancher1-1 <1.25.16-rancher2-1":  canalv3241,
		...
		kdm.Flannel: {
			">=1.32.12-rancher1-1":                    flannelv0281,
			">=1.32.8-rancher1-1 <1.32.12-rancher1-1": flannelv0273,
		...
		kdm.CoreDNS: {
			">=1.28.9-rancher1-1":                     coreDnsv183Rancher3,
			">=1.28.0-rancher1-1 <1.28.9-rancher1-1":  coreDnsv183Rancher2,
			">=1.27.13-rancher1-1 <1.28.0-rancher1-1": coreDnsv183Rancher3,
			">=1.21.9-rancher1-2 <1.27.13-rancher1-1": coreDnsv183Rancher2,
		...
		kdm.Aci: {
			...
			">=1.24.13-rancher2-2 <1.24.17-rancher1-1":  aciv5271,
			">=1.24.17-rancher1-1 <1.25.0-rancher0":     aciv6031,
			...
			">=1.25.13-rancher1-1 <1.25.16-rancher2-2":  aciv6031,
			">=1.25.16-rancher2-2 <1.25.16-rancher2-3":  aciv6032,
			">=1.25.16-rancher2-3 <1.26.0-rancher0":     aciv6033,
			">=1.26.0-rancher0 <1.26.8-rancher1-1":      aciv5271,
			">=1.26.8-rancher1-1 <1.26.11-rancher2-2":   aciv6031,
			">=1.26.11-rancher2-2 <1.26.13-rancher1-2":  aciv6032,
			">=1.26.13-rancher1-2 <1.26.14-rancher1-1":  aciv6033,
			">=1.26.14-rancher1-1 <1.27.0-rancher1-1":   aciv6041,
			">=1.27.0-rancher1-1 <1.27.8-rancher2-1":    aciv5271,
			">=1.27.8-rancher2-1 <1.27.8-rancher2-2":    aciv6031,
			">=1.27.8-rancher2-2 <1.27.10-rancher1-2":   aciv6032,
			">=1.27.10-rancher1-2 <1.27.11-rancher1-1":  aciv6033,
			">=1.27.11-rancher1-1 < 1.27.15-rancher1-1": aciv6041,
			...
			">=1.29.9-rancher1-1 < 1.29.11-rancher1-1":  aciv6111,
			">=1.29.11-rancher1-1 < 1.29.12-rancher1-1": aciv6044,
			">=1.29.12-rancher1-1 < 1.30.0-rancher0":    aciv6112,
			">=1.30.0-rancher0 < 1.30.4-rancher1-1":     aciv6042,
			">=1.30.4-rancher1-1 < 1.30.5-rancher1-1":   aciv6043,
			">=1.30.5-rancher1-1 < 1.30.7-rancher1-1":   aciv6111,
			">=1.30.7-rancher1-1 < 1.30.8-rancher1-1":   aciv6044,
			">=1.30.8-rancher1-1 < 1.30.12-rancher1-1":  aciv6112,
			">=1.30.12-rancher1-1 < 1.31.0-rancher0":    aciv6114,
			">=1.31.0-rancher0 < 1.31.3-rancher1-1":     aciv6111,
			">=1.31.3-rancher1-1 < 1.31.4-rancher1-1":   aciv6044,
			">=1.31.4-rancher1-1 < 1.31.8-rancher1-1":   aciv6112,
			">=1.31.8-rancher1-1 < 1.32.0-rancher0":     aciv6114,
			">=1.32.0-rancher0 < 1.32.4-rancher1-1":     aciv6112,
			">=1.32.4-rancher1-1 ":                      aciv6114,
		},
		kdm.NginxIngress: {
			...
			">=1.24.10-rancher1-1 <1.25.16-rancher2-1": nginxIngressv151Rancher2,
			">=1.25.16-rancher2-1 <1.26.0-rancher1-1":  nginxIngressv194Rancher1,
			...
			">=1.28.14-rancher1-1 <1.28.15-rancher1-1": nginxIngressv1112Rancher2,
			">=1.28.15-rancher1-1 <1.29.0-rancher1-1":  nginxIngressv1113Rancher1,
			...
			">=1.29.9-rancher1-1 <1.29.10-rancher1-1":  nginxIngressv1112Rancher2,
			">=1.29.10-rancher1-1 <1.30.0-rancher1-1":  nginxIngressv1113Rancher1,
			...
			">=1.32.13-rancher1-1 <1.32.13-rancher1-2": nginxIngressv1144Rancher1,
			">=1.32.13-rancher1-2":                     nginxIngressv1145Rancher1,
		},
		kdm.Nodelocal: {
...
func getTemplates() map[string]string {
	return map[string]string{
		...
		calicov3270Rancher2:  CalicoTemplateV3_27_0Rancher2,
		calicov3274:          CalicoTemplateV3_27_4,
		calicov3280:          CalicoTemplateV3_28_0,
		calicov3281:          CalicoTemplateV3_28_1,
		calicov3290:          CalicoTemplateV3_29_0,
		calicov3302:          CalicoTemplateV3_30_2,
		...
		flannelv0251:         FlannelTemplateV0_25_1,
		flannelv0264:         FlannelTemplateV0_26_4,
		flannelv0273:         FlannelTemplateV0_27_3,
		flannelv0281:         FlannelTemplateV0_28_1,
		...
		canalv3274:                    CanalTemplateV3_27_4,
		...
		coreDnsv183Rancher3: CoreDNSTemplateV183Rancher3,
		...
		aciv6031: AciTemplateV6031,
		aciv6032: AciTemplateV6032,
		aciv6033: AciTemplateV6033,
		aciv6041: AciTemplateV6041,
		aciv6042: AciTemplateV6042,
		aciv6043: AciTemplateV6043,
		aciv6111: AciTemplateV6111,
		aciv6044: AciTemplateV6044,
		aciv6112: AciTemplateV6112,
		aciv6114: AciTemplateV6114,
		...
		nginxIngressv1145Rancher1: NginxIngressTemplateV1145Rancher1,
