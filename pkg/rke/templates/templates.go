...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		kdm.Calico: {
			">=1.26.11-rancher2-1":                     calicov3261Rancher2,
		...
		kdm.Canal: {
			">=1.26.11-rancher2-1":                     canalv3261Rancher2,
		...
		kdm.NginxIngress: {
			...
			">=1.26.11-rancher2-1":                     nginxIngressv194Rancher1,
		},
		kdm.Nodelocal: {
