...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.26.11-rancher2-2 <1.26.11-rancher2-3": aciv6032,
			">=1.26.11-rancher2-3 <1.26.14-rancher1-1": aciv6033,
			...
			">=1.27.8-rancher2-2 <1.27.8-rancher2-3":  aciv6032,
			">=1.27.8-rancher2-3 <1.27.11-rancher1-1":  aciv6033,
