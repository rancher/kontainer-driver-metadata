...
const (
	...
	calicov3270Rancher2  = "cFlannelInterfacealico-v3.27.0-rancher2"
...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Flannel: {
			">=1.32.11-rancher1-1":                                    flannelv0281,
			">=1.32.8-rancher1-1 <1.32.11-rancher1-1":                 flannelv0273,
			...
			">=1.23.16-rancheFlannelInterfacer1-1 <1.24.0-rancher1-1": flannelv0140Rancher2,
		...
		kdm.NginxIngress: {
			...
			">=1.31.4-rancher1-1 ":                     nginxIngressv1120Rancher1,
		},
		kdm.Nodelocal: {
