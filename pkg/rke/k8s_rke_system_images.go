...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.29.6-rancher1-1": {
			...
			Alpine:                    "rancher/rke-tools:v0.1.97",
		...
		"v1.30.2-rancher1-1": {
			...
			Alpine:                    "rancher/rke-tools:v0.1.99",
			NginxProxy:                "rancher/rke-tools:v0.1.99",
			CertDownloader:            "rancher/rke-tools:v0.1.99",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.99",
