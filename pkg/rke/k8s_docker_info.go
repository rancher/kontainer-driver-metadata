...
func loadK8sVersionDockerInfo() map[string][]string {
	return map[string][]string{
		...
		"1.29": {"1.13.x", "17.03.x", "17.06.x", "17.09.x", "18.06.x", "18.09.x", "19.03.x", "20.10.x", "23.0.x", "24.0.x", "25.0.x", "26.0.x", "26.1.x", "27.0.x", "27.1.x", "27.2.x", "27.3.x", "27.4.x", "27.5.x", "28.0.x", "28.1.x"},
