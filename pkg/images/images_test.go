...
func Test_toKeep(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "2.7.0 < deprecated < 2.8.0 ",
			args: args{info: types.K8sVersionInfo{
				MinRancherVersion:       "",
				MaxRancherVersion:       "",
				DeprecateRancherVersion: "2.7.2",
			}},
			want:    true,
			wantErr: false,
		},
		{
			name: "2.7.0 < deprecated < 2.8.0 - 2",
			args: args{info: types.K8sVersionInfo{
				MinRancherVersion:       "",
				MaxRancherVersion:       "",
				DeprecateRancherVersion: "2.7.5-alpha1",
			}},
			want:    true,
			wantErr: false,
		},
		{
			name: "deprecated = 2.8.0",
			args: args{info: types.K8sVersionInfo{
				MinRancherVersion:       "",
				MaxRancherVersion:       "",
				DeprecateRancherVersion: "2.8.0",
			}},
			want:    true,
			wantErr: false,
		},
		{
			name: "min < 2.7.0 < 2.8.0 < max",
			args: args{info: types.K8sVersionInfo{
				MinRancherVersion:       "2.6.12-alpha2",
				MaxRancherVersion:       "2.8.2",
				DeprecateRancherVersion: "",
			}},
			want:    true,
			wantErr: false,
		...
		{
			name: "min < 2.7.0 < max = 2.8.0",
			args: args{info: types.K8sVersionInfo{
				MinRancherVersion:       "2.6.12-alpha2",
				MaxRancherVersion:       "2.8.0",
				DeprecateRancherVersion: "",
			}},
			want:    true,
			wantErr: false,
		},
		{
			...
			args: args{info: types.K8sVersionInfo{
				MinRancherVersion:       "2.6.12-alpha2",
				MaxRancherVersion:       "2.7.12-patch1",
				DeprecateRancherVersion: "",
			}},
			want:    true,
			wantErr: false,
		...
		{
			name: "2.8.0 < min < 2.8.99 < max",
			args: args{info: types.K8sVersionInfo{
				MinRancherVersion:       "2.8.1-patch1",
				MaxRancherVersion:       "2.9.0-alpha1",
				DeprecateRancherVersion: "",
			}},
			want:    false,
			wantErr: false,
...
func Test_releaseToKeep(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{release: map[string]interface{}{
				"minChannelServerVersion": "v2.6.0-alpha1",
				"maxChannelServerVersion": "v2.8.1",
		...
		},
		{
			...
			args: args{release: map[string]interface{}{
				...
				"maxChannelServerVersion": "v2.8.0",
				"version":                 "v1.20.15+rke2r2"},
			},
			want:    true,
			wantErr: false,
		...
		},
		{
			...
			args: args{release: map[string]interface{}{
				...
				"maxChannelServerVersion": "v2.7.14-patch1",
				"version":                 "v1.20.15+rke2r2"},
			},
			want:    true,
			wantErr: false,
		},
		{
			name: "2.8.0 < min < 2.8.99 < max",
			args: args{release: map[string]interface{}{
				"minChannelServerVersion": "v2.8.1-alpha1",
				"maxChannelServerVersion": "v2.9.0-patch1",
				"version":                 "v1.20.15+rke2r2"},
			},
			want:    false,
			wantErr: false,
