...
replace (
	...
	k8s.io/externaljwt => k8s.io/externaljwt v0.34.11
	k8s.io/kms => k8s.io/kms v0.34.11
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.34.11
	k8s.io/sample-controller => k8s.io/sample-controller v0.34.11
)
